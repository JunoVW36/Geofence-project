...
DEBUG = True
CSRF_COOKIE_SECURE = False # Change to True when deploying other than local
SESSION_COOKIE_SECURE = False # Change to True when deploying other than local
...
#Google Storage settings (using 'stoages' library)
