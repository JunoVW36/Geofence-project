...
# --- CORS headers config ----
CORS_URLS_REGEX = r'^/api/.*$' # Limits the CORS headers for only the API urls
CORS_ORIGIN_WHITELIST = (
    'localhost:8001', # for Staging environment only
    'localhost:8002', # for Staging environment only
    'localhost:8003', # for Staging environment only
    'localhost:8004', # for Staging environment only
    'localhost:8005', # for Staging environment only
    'localhost:8006', # for Staging environment only
    'localhost:8007', # for Staging environment only
    'localhost:8008', # for Staging environment only
    'localhost:8009', # for Staging environment only
    'localhost:8010', # for Staging environment only
    'localhost:3000', # for Staging environment only
)
